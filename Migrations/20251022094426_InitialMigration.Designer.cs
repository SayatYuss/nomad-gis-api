...
namespace nomad_gis_V2.Migrations
{
    ...
    [Migration("20251022094426_InitialMigration")]
            ...
            modelBuilder.Entity("nomad_gis_V2.Models.Message", b =>
                {
                    ...
                    b.HasOne("nomad_gis_V2.Models.MapPoint", null)
                        .WithMany("Messages")
                        .HasForeignKey("MapPointId1");
